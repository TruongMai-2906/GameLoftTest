...
const BannerDescription = (props) => {
  ...
  return (
    <div className={container.container}>
      <CustomTag is="p" content={data.title} className={container['container__title']}></CustomTag>
      <div className={container['container__sub-title']}>
        <Article articleList={data.articleList} />  | <RateStar stars={data.stars} />
      </div>
      <CustomTag is="p" content={data.description} className={container['container__description']}></CustomTag>
    </div>
  )
}
