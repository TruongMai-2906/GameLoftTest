...
const SocialPost = (props) => {
  ...
  const [filterList, setFilterList] = useState(list.filter((item, index) => index < 10));
  const onSubmit = (data) => {setFilterList(doFilterList(data.search));setMobileList(doFilterList(data.search))}
  ...
  const [mobileList, setMobileList] = useState(filterList.filter((item,index) => index < countItem));
  const loadMore = () => {setCountItem(countItem+3);setMobileList(filterList.filter((item,index) => index < countItem))}
    ...
    <div className={container.container}>
      <Container className={container["container-top"]}>
        ...
        <div className={container["container-top__right"]}>
          ...
          <div className={`${container["container-top__right-search-bar"]} ${container["container-top__right-search-bar-pc"]}`}>
      ...
      <div className="container">
        <div className={`${container["container-top__right-search-bar"]} ${container["container-top__right-search-bar-mb"]}`}>
          <form onSubmit={handleSubmit(onSubmit)}>
            <input
              type="search"
              name="search"
      ...
      <div className={container["container-bottom"]}>
        ...
        >
          {filterList.map((e,i) =>
            <SwiperSlide className={container['container-bottom__item']}>
              <a href="/" target="_blank"><img src={facebook} alt="facebook" /></a>
              <a href="/" target="_blank"><i className="fas fa-share-alt"></i></a>
              <CustomTag is="p" content={e.content} className={container['container-bottom__item-content']}></CustomTag>
            </SwiperSlide>
          )}
        ...
        <div className={container["container-bottom-mb"]}>
          {mobileList.map((e,i) =>
            <div className={container['container-bottom__item']}>
              <a href="/" target="_blank"><img src={facebook} alt="facebook" /></a>
              <a href="/" target="_blank"><img src={share} alt="share" /></a>
              <CustomTag is="p" content={e.content} className={container['container-bottom__item-content']}></CustomTag>
            </div>
          )}
