...
const SocialStories = (props) => {
  const NextArrow = ({ onClick }) => {
    return (
      <div
        className={container["container__slide-right-arrow"]}
        onClick={onClick}
      >
  ...
  const PrevArrow = ({ onClick }) => {
    return (
      <div
        className={container["container__slide-left-arrow"]}
        onClick={onClick}
      >
  ...
  return (
    <Container className={container.container}>
      ...
      <CustomTag
        ...
        className={container["container__sub-title"]}
      ></CustomTag>
      <Slider {...settings}>
        {list.map((e, i) => (
          <div
            className={
              i === index
                ? `${container["container__slide-item"]} ${container["container__active"]}`
                : `${container["container__slide-item"]}`
            }
            key={`stories${i}`}
          >
            ...
            <CustomTag
              is="p"
              content={e.title}
              className={container["container__item-title"]}
            ></CustomTag>
          </div>
        ))}
      </Slider>
