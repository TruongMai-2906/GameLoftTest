    ...
    <section>
      <div className={container.container} data-aos="fade-up">
        <Container>
          ...
          <CustomTag
            is="p"
            content="Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos."
